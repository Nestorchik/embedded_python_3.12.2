...
with dpg.window() as main_window:
    ...
    dpg.add_button(label="Press here!", callback=move_group,
                   user_data=(my_group, child_window))


dpg.set_primary_window(main_window, True)
dpg.create_viewport(title='Test program from NStor!', width=500, height=300)
dpg.setup_dearpygui()
dpg.show_viewport()
dpg.start_dearpygui()
dpg.destroy_context()
